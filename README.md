...
* Ответ
    ...
    * В таблице базы данных не существует строки с указанным `id`.
    ...
    ```
    Здесь "__" — пустая клетка. Две буква обозначают фигуру: первая буква — первая буква названия цвета фигуры, вторая — буква обозначает тип фигуры в шахматной нотации (например, "WR" — White Rook).
